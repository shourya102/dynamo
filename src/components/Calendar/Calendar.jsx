                ...
                <div className='flex  p-4 pt-9 justify-between items-center   '>
                    <button onClick={goToPreviousMonth}
                        ...
                        <FiChevronLeft size={30}
                                       opacity={selectedYear == 2023 && selectedMonth == 1 ? '40%' : '120%'}></FiChevronLeft>
                    </button>
                    ...
                    <button onClick={goToNextMonth} disabled={currentMonth == selectedMonth ? true : false}>
                        <FiChevronRight size={30}
                                        opacity={currentMonth == selectedMonth ? '40%' : '120%'}></FiChevronRight>
                    </button>
                </div>
                <div>
                    ...
                    <div className="">
                        ...
                        <div className='grid grid-cols-7 gap-1 pt-0 pl-5 p-4 '>
                            {days.map((data) => {
                                return (
                                    <p key={data}
                                       className={`inline-flex w-9 rounded-full p-2 item-center justify-center`}>{data}</p>
                                );
                            })}
