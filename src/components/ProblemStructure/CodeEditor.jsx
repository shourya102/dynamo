  ...
  return (
    <div>
      <div className="flex flex-row ">
        <ProblemDescription />
        <div
          className={`w-[73%] flex flex-col gap-3 relative top-0 right-0`}
          style={cntstyle}
        >
          <div className="bg-skin-base-2 h-[70%]  overflow-auto">
            <div className="flex justify-between p-3 mt-2  ps-6 bg-skin-base-3">
              <select
                name="lang"
                id=""
                className="focus:outline-none p-1 bg-transparent"
              >
            ...
            <div className="h-[78%] ">
              <textarea
                name=""
                id="editor"
                className=" w-[100%] h-[100%] resize-none"
              ></textarea>
            </div>
            <div className="flex justify-end items-center px-6 w-[100%] h-[12%]">
              <div className="flex flex-row justify-center items-center gap-2 ">
                <button className="p-3 px-5  bg-skin-base-1 rounded-3xl shadow-lg  ">
                  Run
                </button>
                <button className="p-3 px-5  bg-skin-base-1 rounded-3xl  shadow-lg ">
                  Submit
