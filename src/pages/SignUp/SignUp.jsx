  ...
  return (
    <div className="SignIn flex justify-center items-center">
      <div className="fixb flex flex-col items-center w-5/6 md:w-3/4 lg:w-1/3 shadow-md  bg-skin-base-3 rounded-3xl">
        ...
        {verifying && (
          <div className="p-9 w-full flex flex-col space-y-4">
            <div className="space-y-2 flex flex-col">
              ...
              <input
                type="text"
                placeholder="ex901-2..."
                className="rounded-3xl focus:outline-2 focus:outline-amber-600 p-3"
            ...
            <button
              className="bg-slate-700 p-3 rounded-3xl hover:bg-slate-600 text-white"
